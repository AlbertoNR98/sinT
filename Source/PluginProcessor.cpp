...
juce::AudioProcessorValueTreeState::ParameterLayout SinTAudioProcessor::createParameterLayout()
{
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>("OSC1FMFREQ", "Oscillator1FMFreq", juce::NormalisableRange<float> {0.0f, 999.9f, 1.0f, 0.3f}, 0.0f, "Hz"));
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>("OSC2FMFREQ", "Oscillator2FMFreq", juce::NormalisableRange<float> {0.0f, 999.9f, 1.0f, 0.3f}, 0.0f, "Hz"));
